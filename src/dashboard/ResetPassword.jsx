    ...
    <div className='absolute w-full h-full top-0 left-0 bg-gr z-[11] select-none'>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <input type="submit" value='reset' className="flex w-full justify-center rounded-md bg-gr px-3 py-1.5 text-lg font-semibold leading-6 text-white shadow-sm cursor-pointer" />
            </div>
          </form>
        </div>
        </div>
